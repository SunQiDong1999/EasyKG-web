...
import SubSidebarMain from './components/SubSidebar/indexMain.vue'
import TopbarMain from './components/Topbar/indexMain.vue'
        ...
        <div id="app-main">
            ...
            <div class="wrapper">
                ...
                <div class="main-container" :style="{'padding-bottom': $route.meta.paddingBottom}">
                    <TopbarMain v-if="!(settingsStore.menu.menuMode === 'head' && !settingsStore.topbar.enableSidebarCollapse && !settingsStore.topbar.enableBreadcrumb)" />
                    <div class="main">
